  ...
  return (
    <section className="relative h-[100vh] min-h-[560px] w-full overflow-hidden bg-[#FBEEDC] text-[#4B2A16]">
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="pointer-events-none overflow-hidden absolute bottom- left-0 h-[100vh] w-full object-cover"
      />
      ...
      <div className="relative mx-auto flex h-full max-w-6xl flex-col justify-between px-5 pt-14 pb-10 sm:px-8 lg:px-10">
        {/* top spacing glue */}
        <div />
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="w-full max-w-xl lg:w-[55%]">
            ...
            >
              ...
              <p className="mt-2 text-[0.95rem] leading-7 text-[#6B4B3B] sm:text-[1rem]">
          ...
          <motion.div
            ...
            className="mt-4 max-w-md text-right lg:mt-0 lg:w-[40%]"
          >
            <p
        ...
        {/* bottom small note */}
        <div className="mt-6 flex flex-col items-center justify-between gap-2 text-[0.8rem] text-[#8A6546] sm:flex-row">
          <p>© {new Date().getFullYear()} Thatha Tea. All rights reserved.</p>
...
function SocialButton({ social }) {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.97 }}
      className="flex items-center justify-between gap-3 rounded-[999px] border border-[#E3C8A9]/70 bg-[#FFF8EF]/85 px-4 py-2.5 shadow-[0_8px_18px_rgba(83,46,27,0.08)] backdrop-blur-sm"
    >
